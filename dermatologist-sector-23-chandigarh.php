...
<head>
    ...
    <title>Dermatologist in Sector 23 Chandigarh | Dermessence (Dr. Sukhmani)</title>
    <meta name="description" content="Dermatologist in Sector 23 Chandigarh providing advanced skin, hair and aesthetic treatments with medical accuracy, ethical care and planned follow-ups.">
    <meta name="keywords" content="Dermatologist Sector 23 Chandigarh, skin specialist Sector 23 Chandigarh, dermatologist clinic near Sector 23 Chandigarh, skin doctor Sector 23 Chandigarh, hair and skin treatment Sector 23 Chandigarh, dermatology clinic Sector 23 Chandigarh">
...
<body>
    ...
    <div class="main-content123">
        ...
        <section class="her123">
            <div class="cnt123">
                <h1>Dermatologist in Sector 23 Chandigarh</h1>
                <p>Ethical Skin, Hair & Aesthetic Care at Dermessence. <strong>Skin specialist Sector 23 Chandigarh</strong> - Dr. Sukhmani.</p>
        ...
        <div class="cnt123">
            ...
            <div class="box123">
                <p>Residents seeking <strong>dermatologist Sector 23 Chandigarh</strong>? Dermessence serves Sector 23's established residential community with medical precision.</p>
                <p><strong>Dermatologist clinic near Sector 23 Chandigarh</strong> addressing environmental stress, pollution, and lifestyle skin concerns.</p>
                <p><strong>Skin doctor Sector 23 Chandigarh</strong> providing evidence-based, personalised dermatology care.</p>
            ...
            <h2 class="ttl123">Why Sector 23 Dermatologist</h2>
            <div class="box123">
                <p><strong>Dermatology clinic Sector 23 Chandigarh</strong> offers:</p>
                <ul>
                    <li>Convenient routine consultations</li>
                    <li>Consistent chronic condition monitoring</li>
                    <li>Personalised long-term planning</li>
                    <li>Strong doctor-patient continuity</li>
                </ul>
                <p>Serving Sector 23's residential community with calm, professional care.</p>
            </div>
            ...
            <!-- Doctor Section -->
            <h2 class="ttl123">Dr. Sukhmani – Sector 23 Specialist</h2>
            <div class="doc123">
                <div class="box123">
                    <h3 style="color: #D4AF37; margin-bottom: 1rem;"><strong>Hair and skin treatment Sector 23 Chandigarh</strong></h3>
                    <p>Sector 23 Chandigarh specialist with ethical, patient-centric approach.</p>
                ...
                <div class="img123">
                    <img src="https://via.placeholder.com/400x500/1a1a1a/D4AF37?text=Dr.+Sukhmani" alt="Dr. Sukhmani - Dermatologist Sector 23 Chandigarh">
                </div>
            </div>
            ...
            <!-- Trusted Clinic -->
            <div class="box123">
                <h3 style="color: #D4AF37; margin-bottom: 1rem;">Trusted Sector 23 Clinic</h3>
                <p>Sector 23 residents choose Dermessence for clinical excellence and ethical care.</p>
            </div>
            ...
            <div class="box123">
                <div class="faq123">
                    <div class="qst123">
                        <span>Q1. Accessible from Sector 23?</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="ans123">Yes, conveniently accessible from Sector 23 and nearby areas.</div>
                </div>
                <div class="faq123">
                    <div class="qst123">
            ...
            <div class="cta-final123">
                ...
                <p style="margin-bottom: 2rem; opacity: 0.9;"><strong>Dermatologist Sector 23 Chandigarh</strong> - Dr. Sukhmani & Team.</p>
                <div style="display: flex; flex-wrap: wrap; gap: 1rem; justify-content: center; align-items: center;">
                    ...
                    <a href="/dermatologist-sector-21-chandigarh/" class="btn123 btn-big123">Sector 21 Clinic</a>
                </div>
