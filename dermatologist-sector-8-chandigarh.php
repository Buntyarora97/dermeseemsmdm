<?php
$page_title = "Dermatologist in Sector 8 Chandigarh | Trusted Skin Care";

$page_description = "Looking for a dermatologist in Sector 18 Chandigarh? Dermessence offers expert skin, hair and aesthetic care with accurate diagnosis and follow-ups.";

$page_keywords = "Dermatologist Sector 8 Chandigarh, skin doctor in Sector 8 Chandigarh, dermatologist near Sector 8 Chandigarh, skin clinic Sector 8 Chandigarh, hair and skin specialist Sector 8 Chandigarh";
...
<head>
    ...
    <title>Dermatologist in Sector 8 Chandigarh | Trusted Skin Care</title>
    <meta name="description" content="Looking for a dermatologist in Sector 8 Chandigarh? Dermessence offers expert skin, hair and aesthetic care with safe diagnosis and follow-ups.">
    <meta name="keywords" content="Dermatologist Sector 8 Chandigarh, skin doctor in Sector 8 Chandigarh, dermatologist near Sector 8 Chandigarh, skin clinic Sector 8 Chandigarh, hair and skin specialist Sector 8 Chandigarh">
...
<body>
    ...
    <div class="main-content123">
        ...
        <section class="her123">
            <div class="cnt123">
                <h1>Dermatologist in Sector 8 Chandigarh</h1>
                <p>Comprehensive Skin, Hair & Aesthetic Care at Dermessence. Trusted <strong>skin doctor in Sector 8 Chandigarh</strong>.</p>
        ...
        <div class="cnt123">
            ...
            <div class="box123">
                <p>Searching for <strong>dermatologist Sector 8 Chandigarh</strong>? Dermessence offers professional care for skin, hair, and aesthetic concerns near Sector 8.</p>
                <p>Sector 8 residents prefer <strong>skin clinic Sector 8 Chandigarh</strong> for accurate diagnosis, ethical treatment, and long-term skin health.</p>
                <p>Trusted <strong>hair and skin specialist Sector 8 Chandigarh</strong> treating medical conditions, not cosmetic fixes.</p>
                <a href="/dermatologist-chandigarh/" class="btn123" style="margin-top: 1rem; display: inline-block;">👉 Explore main dermatology services</a>
            </div>

            <!-- Why Local Dermatologist -->
            <h2 class="ttl123">Why Sector 8 Dermatologist</h2>
            <div class="box123">
                <p><strong>Dermatologist near Sector 8 Chandigarh</strong> offers:</p>
                <ul>
                    <li>Convenience & easy access</li>
                    <li>Timely consultations</li>
                    <li>Consistent follow-up care</li>
                    <li>Personalised treatment plans</li>
                </ul>
                <p>Serving Sector 8 and nearby areas with specialist dermatology.</p>
            </div>
            ...
            <!-- Doctor Section -->
            <h2 class="ttl123">Dr. Sukhmani – Sector 8 Specialist</h2>
            <div class="doc123">
                <div class="box123">
                    <h3 style="color: #D4AF37; margin-bottom: 1rem;">Dermatology Expertise</h3>
                    <p>Serving Sector 8 Chandigarh patients with ethical care.</p>
                ...
                <div class="img123">
                    <img src="https://via.placeholder.com/400x500/1a1a1a/D4AF37?text=Dr.+Sukhmani" alt="Dr. Sukhmani - Dermatologist Sector 8 Chandigarh">
                </div>
            </div>
                ...
                <div class="cnt123">
                    ...
                    <div class="stp123">
                        <div class="step123">
                            ...
                            <p>Medical history, lifestyle, treatment goals discussion.</p>
                        </div>
                        <div class="step123">
                            <div class="num123">2</div>
                            <h4 style="color:gold;">Clinical Exam</h4>
                            <p>Thorough skin/scalp examination for diagnosis.</p>
                        </div>
                        <div class="step123">
                            <div class="num123">3</div>
                            <h4 style="color:gold;">Treatment Plan</h4>
                            <p>Diagnosis, options, timeline explained clearly.</p>
                        </div>
                        <div class="step123">
                            <div class="num123">4</div>
                            <h4 style="color:gold;">Safe Treatment</h4>
                            <p>Clinically approved methods in hygienic environment.</p>
                        </div>
                        <div class="step123">
                            <div class="num123">5</div>
                            <h4 style="color:gold;">Follow-Up</h4>
                            <p>Regular monitoring prevents recurrence.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- Services Grid -->
            <h2 class="ttl123">Dermatology Services</h2>
            <div class="grd123">
                <div class="crd123">
                    <h3><i class="fas fa-clinic-medical"></i> Clinical Care</h3>
                    <p>Acne, infections, pigmentation, eczema, psoriasis treatment.</p>
                ...
                <div class="crd123">
                    ...
                    <p>Microneedling, laser, skin brightening, anti-aging.</p>
                    <a href="/microneedling-chandigarh/" class="btn123" style="margin-top: 1rem; font-size: 0.85rem;">Microneedling</a>
                </div>
                <div class="crd123">
                    <h3><i class="fas fa-hair-long"></i> Hair Treatments</h3>
                    <p>Hair fall, PRP, dandruff, scalp infections.</p>
                    <a href="/hair-loss-doctor-chandigarh/" class="btn123" style="margin-top: 1rem; font-size: 0.85rem;">Hair Loss</a>
                </div>
                <div class="crd123">
                    <h3><i class="fas fa-user-zap"></i> Laser Procedures</h3>
                    <p>Laser hair removal, pigmentation, rejuvenation.</p>
            ...
            <!-- Who Should Visit -->
            <div class="box123">
                <h3 style="color: #D4AF37; margin-bottom: 1rem;">When to Visit</h3>
                <p>Consult if you have:</p>
                <ul>
                    <li>Persistent acne/pigmentation</li>
                    <li>Sudden hair fall/scalp issues</li>
            ...
            <!-- Trusted Clinic -->
            <div class="box123">
                <h3 style="color: #D4AF37; margin-bottom: 1rem;">Trusted Sector 8 Clinic</h3>
                <p><strong>Skin clinic Sector 8 Chandigarh</strong> patients choose Dermessence for clinical excellence and ethical dermatology practices.</p>
            </div>
            ...
            <div class="box123">
                <div class="faq123">
                    <div class="qst123">
                        <span>Q1. Accessible from Sector 8?</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="ans123">Yes, easily accessible from Sector 8 and nearby areas.</div>
                </div>
                <div class="faq123">
                    <div class="qst123">
                        <span>Q2. Medical + cosmetic care?</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="ans123">Complete dermatology including medical, hair, aesthetic treatments.</div>
                </div>
                <div class="faq123">
                    <div class="qst123">
                    ...
                    <div class="ans123">Yes, ensures accurate diagnosis and safe planning.</div>
                </div>
            </div>
            ...
            <div class="cta-final123">
                ...
                <p style="margin-bottom: 2rem; opacity: 0.9;">Trusted <strong>dermatologist Sector 8 Chandigarh</strong> for skin, hair, aesthetics.</p>
