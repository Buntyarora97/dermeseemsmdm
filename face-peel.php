     ...
     <style>
      ...
      <div class="container">
        ...
        <div class="section-card">
            <h2>What are Face Peels?</h2>
            <p>Face peels involve the application of different chemicals, either individually or in combination, to the skin’s surface. The choice of ingredients, their concentrations, and the number of layers applied determine the type and depth of the peel. Peels are broadly categorized into superficial, medium, and deep peels. However, for skin of color, such as ours, only superficial and occasionally carefully performed medium-depth peels are suitable to avoid complications.</p>
            <p>Depending on the targeted concern, sequential peels can be performed. Segmental peels, on the other hand, treat different areas of the face with different types of peels in a single session.</p>
            <p>Additionally, long-stay peels are another option, where the peel is applied and left on as you return home. Face peels work exceptionally well in improving the skin’s texture and tone, delivering noticeable results when done correctly.</p>
        </div>
        ...
        <div class="section-card">
            ...
            <p><strong>Energy based devices:</strong> MNRF, Radiofrequency, HIFU</p>
