<?php
$page_title = "Dermatologist in Sector 18 Chandigarh | Expert Skin Care";
...
$page_keywords = "Dermatologist Sector 18 Chandigarh, skin doctor in Sector 18 Chandigarh, dermatologist near Sector 18 Chandigarh, skin clinic Sector 18 Chandigarh, hair and skin specialist Sector 18 Chandigarh";
...
<head>
    ...
    <title>Dermatologist in Sector 18 Chandigarh | Expert Skin Care</title>
    <meta name="description" content="Looking for a dermatologist in Sector 18 Chandigarh? Dermessence offers expert skin, hair and aesthetic care with accurate diagnosis and follow-ups.">
    <meta name="keywords" content="Dermatologist Sector 18 Chandigarh, skin doctor in Sector 18 Chandigarh, dermatologist near Sector 18 Chandigarh, skin clinic Sector 18 Chandigarh, hair and skin specialist Sector 18 Chandigarh">
...
<body>
    ...
    <div class="main-content123">
        ...
        <section class="her123">
            <div class="cnt123">
                <h1>Dermatologist in Sector 18 Chandigarh</h1>
                <p>Comprehensive Skin, Hair & Aesthetic Care at Dermessence. Trusted <strong>skin doctor in Sector 18 Chandigarh</strong>.</p>
        ...
        <div class="cnt123">
            ...
            <div class="box123">
                <p>Searching for <strong>dermatologist Sector 18 Chandigarh</strong>? Dermessence serves Sector 18's residential & commercial community with medical accuracy.</p>
                <p>Sector 18 residents choose <strong>skin clinic Sector 18 Chandigarh</strong> for reliable solutions beyond cosmetic treatments.</p>
                <p><strong>Hair and skin specialist Sector 18 Chandigarh</strong> delivering evidence-based, customised care.</p>
            ...
            <h2 class="ttl123">Why Sector 18 Dermatologist</h2>
            <div class="box123">
                <p><strong>Dermatologist near Sector 18 Chandigarh</strong> ensures:</p>
                <ul>
                    <li>Convenient access for consultations</li>
                    <li>Faster follow-ups for chronic conditions</li>
                    <li>Personalised long-term planning</li>
                    <li>Consistent care relationship</li>
                </ul>
                <p>Serving Sector 18's well-connected residential area.</p>
            </div>
            ...
            <div class="box123">
                ...
                <ul>
                    ...
                    <li>Modern skin/hair technologies</li>
            ...
            <!-- Doctor Section -->
            <h2 class="ttl123">Dr. Sukhmani – Sector 18 Specialist</h2>
            <div class="doc123">
                <div class="box123">
                    <h3 style="color: #D4AF37; margin-bottom: 1rem;">Dermatology Expertise</h3>
                    <p>Serving Sector 18 Chandigarh with ethical care.</p>
                    <p>Areas of expertise:</p>
                    <ul>
                        <li>Clinical dermatology (acne, eczema)</li>
                        <li>Hair/scalp disorders</li>
                        <li>Aesthetic rejuvenation</li>
                        <li>Preventive skin programs</li>
                    </ul>
                </div>
                <div class="img123">
                    <img src="https://via.placeholder.com/400x500/1a1a1a/D4AF37?text=Dr.+Sukhmani" alt="Dr. Sukhmani - Dermatologist Sector 18 Chandigarh">
                </div>
            </div>
                ...
                <div class="cnt123">
                    ...
                    <div class="stp123">
                        <div class="step123">
                            ...
                            <p>Skin/hair concern, medical history, expectations discussed.</p>
                        </div>
                        <div class="step123">
                        ...
                        <div class="step123">
                            ...
                            <p>Clinically approved methods, hygienic setting.</p>
                        </div>
                        <div class="step123">
            ...
            <div class="grd123">
                ...
                <div class="crd123">
                    ...
                    <p>Microneedling, laser, skin brightening solutions.</p>
                ...
                <div class="crd123">
                    ...
                    <p>Hair fall diagnosis, PRP, dandruff treatment.</p>
                ...
                <div class="crd123">
                    ...
                    <p>Laser hair removal, skin rejuvenation.</p>
            ...
            <!-- Trusted Clinic -->
            <div class="box123">
                <h3 style="color: #D4AF37; margin-bottom: 1rem;">Trusted Sector 18 Clinic</h3>
                <p><strong>Skin clinic Sector 18 Chandigarh</strong> residents trust Dermessence for clinical excellence and ethical care.</p>
            </div>
            ...
            <div class="box123">
                <div class="faq123">
                    <div class="qst123">
                        <span>Q1. Accessible from Sector 18?</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="ans123">Yes, conveniently accessible from Sector 18 and nearby sectors.</div>
                </div>
                <div class="faq123">
                    <div class="qst123">
                    ...
                    <div class="ans123">Complete dermatology care for medical and aesthetic concerns.</div>
                </div>
                <div class="faq123">
                    <div class="qst123">
            ...
            <div class="cta-final123">
                ...
                <p style="margin-bottom: 2rem; opacity: 0.9;">Trusted <strong>dermatologist Sector 18 Chandigarh</strong> for comprehensive skin solutions.</p>
